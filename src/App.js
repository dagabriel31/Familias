...
export default function App({ userRole, userName }) {
    return (
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="admin" element={<ProtectedRoute userRole={userRole} allowedRoles={["Tesoureira", "Apóstolo", "Dev"]}>
              <AdminDashboard />
            </ProtectedRoute>}/>

          {/* Lista de Membros: Só Apóstolo e Dev */}
          <Route path="membros" element={<ProtectedRoute userRole={userRole} allowedRoles={["Apóstolo", "Dev"]}>
              <MembersList />
            </ProtectedRoute>}/>

          {/* Estudos Bíblicos: Pastores e Liderança de Ensino */}
          <Route path="estudos" element={<ProtectedRoute userRole={userRole} allowedRoles={["Pastor", "Apóstolo", "Dev"]}>
              <BibleStudies userRole={userRole} userName={userName}/>
            </ProtectedRoute>}/>

          {/* Gestão de Eventos: Equipa de Mídia e Apóstolo */}
          <Route path="gestao-eventos" element={<ProtectedRoute userRole={userRole} allowedRoles={["Mídia", "Apóstolo", "Dev"]}>
              <EventsManagement userRole={userRole}/>
            </ProtectedRoute>}/>

          {/* Gestão de Ministérios: Equipa de Mídia e Apóstolo */}
          <Route path="gestao-ministerios" element={<ProtectedRoute userRole={userRole} allowedRoles={["Mídia", "Apóstolo", "Dev"]}>
