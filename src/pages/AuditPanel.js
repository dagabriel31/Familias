...
export default function AuditPanel({ totalAtivo }) {
    ...
    return (<div className="glass p-10 rounded-[3rem] border border-white/5 space-y-8 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
            <div className={`h-full transition-all ${diferenca === 0 ? 'bg-destaque' : 'bg-red-500'}`} style={{ width: `${(totalAtivo / (ultimoBackup?.valorTotalNoMomento || 1)) * 100}%` }}/>
          </div>
        </div>
