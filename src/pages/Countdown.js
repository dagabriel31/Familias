...
export default function EventCountdown() {
    ...
    useEffect(() => {
        ...
        const hoje = new Date();
        const q = query(collection(db, "eventos"), where("data", ">=", hoje), orderBy("data", "asc"), limit(1));
...
function TimeUnit({ value, label }) {
    return (<div className="glass p-6 rounded-[2.5rem] border border-white/5 group hover:border-destaque/30 transition-all">
